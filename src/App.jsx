    ...
    <>
      <nav style={styles.nav}>
        <Link to="/" style={styles.navBrand}>
          <span style={styles.brandText}>Brooklyn Slice</span>
        </Link>
        ...
        {isMobile ? (
          ...
          <>
            ...
            <Link to="/online-ordering" style={styles.navLink}>Online Ordering</Link>
            <Link to="/catering" style={styles.navLink}>Catering</Link>
      ...
      {isMobile && menuOpen && (
        <div style={styles.mobileMenuOverlay} onClick={() => setMenuOpen(false)}>
          <div style={styles.mobileMenu} onClick={(e) => e.stopPropagation()}>
            ...
            <Link to="/about-us" style={styles.mobileNavLink}>About Us</Link>
            <Link to="/contact" style={styles.mobileNavLink}>Contact</Link>
            <Link to="/online-ordering" style={styles.mobileNavLink}>Online Ordering</Link>
            <Link to="/catering" style={styles.mobileNavLink}>Catering</Link>
            <Link to="/reviews" style={styles.mobileNavLink}>Reviews</Link>
      ...
      <div style={styles.app}>
        <NavWrapper>
          ...
          <footer style={styles.footer}>
            <p>© 2026 Brooklyn Slice. All rights reserved.</p>
          </footer>
        </NavWrapper>
      </div>
    </BrowserRouter>
